...
enum InvokeHostFunctionResultCode
{
    ...
    INVOKE_HOST_FUNCTION_CODE_SIZE_ABOVE_NETWORK_LIMIT = -6,
    INVOKE_HOST_FUNCTION_DATA_SIZE_ABOVE_NETWORK_LIMIT = -7
};
...
case INVOKE_HOST_FUNCTION_CODE_SIZE_ABOVE_NETWORK_LIMIT:
case INVOKE_HOST_FUNCTION_DATA_SIZE_ABOVE_NETWORK_LIMIT:
    void;
};
...
enum TransactionResultCode
{
    ...
    txSOROBAN_INSTRUCTIONS_ABOVE_NETWORK_LIMIT = -17,
    txSOROBAN_READ_BYTES_ABOVE_NETWORK_LIMIT = -18,
    txSOROBAN_WRITE_BYTES_ABOVE_NETWORK_LIMIT = -19,
    txSOROBAN_READ_ENTRIES_ABOVE_NETWORK_LIMIT = -20,
    txSOROBAN_WRITE_ENTRIES_ABOVE_NETWORK_LIMIT = -21,
    txSOROBAN_TX_SIZE_ABOVE_NETWORK_LIMIT = -22,
    txSOROBAN_INVALID_READ_FOOTPRINT = -23,
    txSOROBAN_INVALID_WRITE_FOOTPRINT = -24
};
...
struct InnerTransactionResult
{
    ...
    case txMALFORMED:
    case txSOROBAN_INSTRUCTIONS_ABOVE_NETWORK_LIMIT:
    case txSOROBAN_READ_BYTES_ABOVE_NETWORK_LIMIT:
    case txSOROBAN_WRITE_BYTES_ABOVE_NETWORK_LIMIT:
    case txSOROBAN_READ_ENTRIES_ABOVE_NETWORK_LIMIT:
    case txSOROBAN_WRITE_ENTRIES_ABOVE_NETWORK_LIMIT:
    case txSOROBAN_TX_SIZE_ABOVE_NETWORK_LIMIT:
    case txSOROBAN_INVALID_READ_FOOTPRINT:
    case txSOROBAN_INVALID_WRITE_FOOTPRINT:
        void;
    }
    result;
