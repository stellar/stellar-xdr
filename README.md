...
- **`main`** — The source of truth for all XDR definitions. All changes should be made to this branch. Definitions may
  contain `#ifdef` / `#ifndef` preprocessor directives to gate features.
